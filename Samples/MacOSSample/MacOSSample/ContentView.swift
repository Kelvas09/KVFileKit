...
public final class ViewModel: ObservableObject {
    ...
    var directoryUrl = URL(fileURLWithPath: "/Users")
    ...
    func refreshEntries() {
        entries = fileSystem.getEntries(from: directoryUrl).compactMap {
    ...
    func goBack() {
        self.directoryUrl = directoryUrl.deletingLastPathComponent()
        self.refreshEntries()
    }
